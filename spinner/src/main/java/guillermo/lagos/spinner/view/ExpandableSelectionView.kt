package guillermo.lagos.spinner.view
...
import guillermo.lagos.spinner.adapter.ExpandableItemAdapter
import guillermo.lagos.spinner.adapter.ExpandableItemRecyclerAdapter
...
abstract class ExpandableSelectionView @JvmOverloads constructor(
    ...
    private var bgDrawable: Drawable? = getDrawable(context, R.drawable.spinner_bg)
    ...
    init {
        ...
        errorLabel = inflate(R.layout.spinner_error) as TextView
